...
function [E2]=BPM_Gullstrand_Emsley(E1,delta_z,delta_image,wavelength, length_position, Lens, TF_pupil)
if length_position == 0
    
    E2 = Lens(1).TF.*E1;

elseif length_position > 0 && length_position < 3.6e-3
...
elseif length_position  > 3.6e-3 && length_position <= 7.3e-3
